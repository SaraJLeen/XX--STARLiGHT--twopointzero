return Def.ActorFrame{
  ...
  Def.ActorFrame{
    ...
    Def.Sprite{
      Texture="text",
      Name="Actual",
      OnCommand=function(s) s:diffusealpha(0):zoom(1.2):sleep(0.2):linear(0.5):diffusealpha(1):accelerate(0.1):zoomy(1.1):linear(0.1):zoom(1):sleep(1.905):diffusealpha(0.6):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0.5):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0.4):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0.3):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0.2):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0.1):sleep(0.059):diffusealpha(1):sleep(0.059):diffusealpha(0) end,
    };
    Def.Sprite{
      Texture="text",
      Name="Back",
      InitCommand=function(s) s:blend(Blend.Add) end,
      OnCommand=function(s) s:diffusealpha(0):zoom(0.3):linear(1):zoom(1):diffusealpha(0.5):sleep(0):zoomx(1.3):linear(0.1):zoomx(2.3):zoomy(2):diffusealpha(0) end,
    };
    Def.Sprite{
      Texture="text",
      InitCommand=function(s) s:blend(Blend.Add) end,
