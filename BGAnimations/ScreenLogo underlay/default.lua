...
return Def.ActorFrame{
  ...
  Def.Sprite{
    ...
    InitCommand=function(s) 
      ...
      s:diffuseshift():effectcolor1(Alpha(Color.White,0.5))
      :effectcolor2(Alpha(Color.White,0)):effectperiod(5) 
    end,
  ...
  Def.Sprite{
    ...
    InitCommand=function(s) 
      s:xy(_screen.cx+310,_screen.cy+70):diffusealpha(0):zoom(1.15):blend(Blend.Add)
  ...
  Def.Actor{
	...
	Def.Sound{
		Name="BGM";
		File=THEME:GetPathS("_ScreenLogo","music"),
