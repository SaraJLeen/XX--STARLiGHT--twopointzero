...
t[#t+1] = Def.BitmapText{
    ...
    OnCommand=function(s)
        s:zoom(1):xy(SCREEN_CENTER_X-300,SCREEN_CENTER_Y-310):halign(0):draworder(100):shadowlength(1)
...
for i=1,10 do
    t[#t+1] = Def.ActorFrame{
        OnCommand=function(s)
            s:xy( SCREEN_CENTER_X-250, SCREEN_CENTER_Y-300+(34*i) ):draworder(100)
    ...
    t[#t+1] = Def.ActorFrame{
        OnCommand=function(s)
            s:xy( SCREEN_CENTER_X+230, SCREEN_CENTER_Y-300+(34*i) ):draworder(100)
            :diffuse( JudgmentLineToColor("JudgmentLine_" .. JudgNames[i]) )
...
t[#t+1] = Def.BitmapText{
    ...
    OnCommand=function(s)
        s:shadowlength(1):zoom(1):xy(SCREEN_CENTER_X+150,SCREEN_CENTER_Y-310):halign(0):draworder(100)
        :diffusealpha(0):sleep(0.2):linear(0.05):diffusealpha(1)
    end,
    OffCommand=function(s) s:linear(0.05):diffusealpha(0) end,
    SmartTimingsChangeMessageCommand=function(s,param)
