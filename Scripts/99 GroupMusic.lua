do
	...
	local musicg = {
		group = {
			...
			["itg 04 - rebirth"]		= "GroupMusic/group/ITG Rebirth (loop)";
			...
			["piu 03 - exceed ~ zero"]	= "GroupMusic/group/PIU EX (loop)";
