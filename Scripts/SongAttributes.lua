...
SongAttributes_GetMenuColor=function(song)
...
SongAttributes_GetMeterType=function(song)
	local group = song:GetGroupName()
	if group == "<Favorites>" then group = string.match(song:GetSongDir(), "/Songs/(.-)/") end
...
SongAttributes_GetGroupName=function(group)
...
SongAttributes_GetGroupColor=function(group)
