...
return {
	...
	Fail =
	{
		Default = "Bar",
		UserPref = true,
		Choices = { THEME:GetString("OptionNames","Immediate"), THEME:GetString("OptionNames","ImmediateContinue"), THEME:GetString("OptionNames","EndOfSong"), THEME:GetString("OptionNames","80Percent"), THEME:GetString("OptionNames","Off") },
		Values = { "Immediate", "ImmediateContinue", "EndOfSong", "80Percent", "Off" },
		LoadFunction = function(self,list,pn)
